...
Maker Skill Trees are printable templates that can you can use to visualise your skill progress, identify skill gaps and get inspired to try new things.  Color in the boxes as you go, starting at the base in the basics and moving to advanced skills at the top. This repository is always growing and aims to include a large variety of skills, see full list below.   Everyone's journey is different and you can interpret the goals flexibly.  Not everything needs to be completed, and tiles can be completed out of order.  Print your own in A4 or A3 size.  This project is collaborative and aims to refine and grow these resources through community involvement.
...
Skill Seeker: Maker Edition combines 15 Maker Skills into one book, allowing you to track a range of skills, calculate your Maker XP score and show off your skill levels in a video game style dashboard.  Complete goal setting activities and upskill with friends and family. Skill Seeker is now [available for pre-order!](https://www.amazon.com/Skill-Seeker-Practical-Growth-Skills/dp/1680458574)
...
☐ Bicycles - Riding, Repair, Maintenance commuting, bikepacking, etc
